          ...
          <div className="relative z-10 h-full flex flex-col justify-end px-6 lg:px-10 pb-8">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-mono tracking-widest uppercase text-primary">Quantic EMBA · Class of July 2027</span>
              </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">WealthBridge · National Life Group · Arizona Region</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
